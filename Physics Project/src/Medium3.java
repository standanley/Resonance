...
public class Medium3 {
    ...
    final static int rays = 10000;
    final static int cells = 512;
    final static double step = 1.0 / cells;
    static double decay = .7;
    static double distDecay = 1;

    private static final double THRESHHOLD = .01;

    private static final double MAX_COLOR = 40;
    ...
    public Medium3(double frequency1) {
    ...
    public void calculate() {
        for (int i = 0; i < rays; i++) {
            ...
            ray(centerX*.68, centerY*1.82, i * TwoPI / rays, amplitudeInit, 0, 0);
    ...
    public static void main(String[] args) {
        ...
        for (double freq = .4; freq < 20; freq += .05) {
            Medium3 plate1 = new Medium3(1 / freq);
            plate1.calculate();
            plate1.draw();
            
            StdDraw.save("group8/pic"+piccount+".png");
        ...
        **/
        ...
        /**
        Medium3 plate2 = new Medium3(.33333333);
        plate2.calculate();
        plate2.draw();
